...
for num_clients in num_clients_list:
    ...
    '''command = "pkill gradingserver"
    os.system(command)
    os.system("cd /home/vedant/Practicals/DECS/lab_08_server")
    command = ("./gradingserver 8000")
    result = subprocess.run(command, shell=True, stdout=subprocess.PIPE, text=True)
    
     command = "/home/vedant/Practicals/DECS/lab_08_server"
    result = subprocess.run(command, shell=True, stdout=subprocess.PIPE, text=True)
    
    os.system("cd /home/vedant/Practicals/DECS/lab_08")
    '''
